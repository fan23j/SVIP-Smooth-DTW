...
CONFIG.ALIGNMENT.DTW_RELAXATION = 'dtw_minGamma'
...
# random for training BUT all for testing
CONFIG.DATA.SAMPLING_STRATEGY = 'random'
# number of frames that will be embedded jointly,(i.e. context frames)
CONFIG.DATA.NUM_CONTEXT_FRAMES = 2
CONFIG.DATA.FRAME_STRIDE = 15  # stride between context frames
# True if framewise labels are available (PS: only used at test time)
